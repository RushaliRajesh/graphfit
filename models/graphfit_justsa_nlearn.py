...
class GraphLayer(nn.Module):
    def __init__(self, dim=64, k1=40, k2=20):
        ...
        self.sa1 = SelfAttentionLayer(self.dim*2)
        self.sa2 = SelfAttentionLayer(self.dim*2)

    def forward(self, x):
        # print("batchsize:", x.shape[0])
        ...
        # pdb.set_trace()
        x_knn1 = x_knn1.permute(0,2,3,1)
        x_knn1, weights = self.sa1(x_knn1)
        x_knn1 = x_knn1.permute(0,3,1,2)
        x_knn1 = self.conv1(x_knn1)  # (batch_size, 64*2, num_points, k) -> (batch_size, 64, num_points, k)
        ...
        x_knn2 = x_knn2.permute(0,2,3,1)
        # print(x_knn2.shape)
        x_knn2, weights2 = self.sa2(x_knn2)
        x_knn2 = x_knn2.permute(0,3,1,2)
        x_knn2 = self.conv3(x_knn2)  # (batch_size, 64*2, num_points, k) -> (batch_size, 64, num_points, k)
